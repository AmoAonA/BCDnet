# Default configuration for BCDnet
...
_C.SOLVER.GAMMA = 0.1
_C.SOLVER.WARMUP_EPOCHS = 1.0 / 1000
...
_C.SOLVER.LW_RCNN_REID_1ST = 0.5
...
_C.SOLVER.LW_RCNN_SOFTMAX_4TH = 0.5
...
_C.MODEL.TRANSFORMER.USE_CONCAT_SHORTCUT = False
_C.MODEL.TRANSFORMER.USE_FEATURE_MASK = True
...
_C.MODEL.LOSS.USE_SOFTMAX = False

_C.MODEL.LOSS.CLASS_WEIGHTS = None

_C.MODEL.LOSS.GIOU_WEIGHTS = None
_C.MODEL.LOSS.L1_WEIGHTS = None
_C.MODEL.LOSS.NO_OBJECT_WEIGHT = None
_C.MODEL.LOSS.DEEP_SUPERVISION = None
_C.MODEL.LOSS.USE_FOCAL = None
_C.MODEL.LOSS.REID_WEIGHTS = None
# -------------------------------------------------------- #
#                        Evaluation                        #
# -------------------------------------------------------- #
