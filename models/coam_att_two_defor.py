...
from torchvision.ops import MultiScaleRoIAlign,PSRoIAlign
...
from models.wavemlp import WaveHead_two
# baseline
...
class COAT(nn.Module):
    def __init__(self, cfg):
        ...
        # box_roi_pool = PSRoIAlign(output_size=14,spatial_scale=1.0,sampling_ratio=2)
...
class CascadedROIHeads(RoIHeads):
    ...
    def __init__(
        ...
        # self.embedding_head_2nd_copy = deepcopy(self.embedding_head_2nd)
        self.embedding_head_3rd = deepcopy(self.embedding_head_2nd)
        # self.embedding_head_3rd_copy = deepcopy(self.embedding_head_2nd)
        # OIM
        ...
        # self.fc = nn.Conv2d(1024,2048,1,1,0)
        # evaluation
        self.eval_feat = cfg.EVAL_FEATURE
    ...
    def forward(self, features, boxes, image_shapes, targets=None, query_img_as_gallery=False):
        ...
        # y_1st = self.fc(y_1st)
        # _,box_regs_1st = self.box_predictor_1st(y_1st) # 待改
        # _, box_regs_1st = self.box_predictor_1st_copy(y_1st)
        ...
        box_features, y_2nd = self.box_head_2nd(box_features)
        box_regs_2nd = self.box_predictor_2nd(y_2nd)
        box_embeddings_2nd, box_cls_scores_2nd  = self.embedding_head_2nd(box_features)
        # _,= self.embedding_head_2nd_copy(box_features)
        # box_embeddings_2nd 作为 deformable roi pooling
        ...
        #_, box_cls_scores_3rd = self.embedding_head_3rd_copy(box_features)
