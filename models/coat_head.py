...
class CascadedROIHeads(RoIHeads):
    ...
    def __init__(
        ...
        self.box_predictor_1st_ = deepcopy(self.box_predictor)
    ...
    def forward(self, features, boxes, image_shapes, targets=None, query_img_as_gallery=False):
        ...
        box_features, y_1st = self.box_head_1st(box_features)
        box_regs_1st = self.box_predictor_1st_(y_1st)
        box_cls_scores_1st, _ = self.box_predictor_1st(box_features['after_trans'])
        ...
        #_,  = self.embedding_head_2nd(box_features)
        ...
        # _,  = self.embedding_head_3rd(box_features)
