...
from models.backbone.swin import swin_tiny_patch4_window7_224, swin_small_patch4_window7_224, swin_base_patch4_window7_224
...
def build_swin(name="swin_tiny", pretrained=True, semantic_weight=1.0):
    if 'tiny' in name and pretrained == pretrained:
        swin = swin_tiny_patch4_window7_224(drop_path_rate=0.1, semantic_weight=semantic_weight, pretrained='./tiny')
        out_channels = 384
    elif 'small' in name and pretrained == pretrained:
        swin = swin_small_patch4_window7_224(drop_path_rate=0.1, semantic_weight=semantic_weight, pretrained='./small')
        out_channels = 384
    elif 'base' in name and pretrained == pretrained:
        swin = swin_base_patch4_window7_224(drop_path_rate=0.1, semantic_weight=semantic_weight, pretrained='./base')
        out_channels = 512
