...
class COAT(nn.Module):
    ...
    def forward(self, images, targets=None, query_img_as_gallery=False):
        ...
        losses["loss_rcnn_reid_1st"] *= self.lw_rcnn_reid_2nd
...
class CascadedROIHeads(RoIHeads):
    ...
    def __init__(
        ...
        self.embedding_head_1st = deepcopy(self.embedding_head_2nd)
        ...
        self.reid_loss_1st = deepcopy(self.reid_loss_2nd)
    ...
    def forward(self, features, boxes, image_shapes, targets=None, query_img_as_gallery=False):
        ...
        box_embeddings_1st, _ = self.embedding_head_1st(box_features_1st)

        if box_cls_scores_1st.dim() == 0:
            box_cls_scores_1st = box_cls_scores_1st.unsqueeze(0)
        ...
        if self.training:
            ...
            loss_rcnn_reid_1st, _, _ = self.reid_loss_2nd(box_embeddings_1st,box_pid_labels_1st)
