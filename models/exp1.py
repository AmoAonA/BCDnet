...
from models.trans_baseline import TransformerHead
...
class COAT(nn.Module):
    def __init__(self, cfg):
        ...
        self.lw_rcnn_reid_1st = cfg.SOLVER.LW_RCNN_REID_1ST
    ...
    def forward(self, images, targets=None, query_img_as_gallery=False):
        ...
        losses["loss_rcnn_reid_1st"] *= self.lw_rcnn_reid_1st
...
class CascadedROIHeads(RoIHeads):
    ...
    def forward(self, features, boxes, image_shapes, targets=None, query_img_as_gallery=False):
        ...
        if self.training:
            ...
            loss_rcnn_reid_1st, _, _ = self.reid_loss_1st(box_embeddings_1st, box_pid_labels_1st)
