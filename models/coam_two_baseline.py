...
from models.wavemlp_aug import WaveHead_two  # my_baseline
from models.transformer import TransformerHead_two,TransformerHead
...
class COAT(nn.Module):
    def __init__(self, cfg):
        ...
        box_head_2nd = TransformerHead_two(
            cfg=cfg,
            trans_names=cfg.MODEL.TRANSFORMER.NAMES_2ND,
            kernel_size=cfg.MODEL.TRANSFORMER.KERNEL_SIZE_2ND,
            use_feature_mask=cfg.MODEL.TRANSFORMER.USE_MASK_2ND,
        )
        box_head_3rd = TransformerHead_two(
            cfg=cfg,
